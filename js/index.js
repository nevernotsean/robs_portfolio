...
var app = {
    ...
    getProjects: function() {
        ...
        self.client.getEntries({
            ...
            function(response) {
                self.projectData = response.items[0].fields.projectsReference
    ...
    locationWrite: function() {
        ...
        var url = window.location.origin + window.location.pathname // Temporary Until Live
    ...
    buildProject: function() {
        ...
        // Begin Row Loop
        // console.dir(self.currentProject.fields)
        for (var i = 0; i < self.currentProject.fields.assets.length; i++) {
            ...
            if (vimID) {
                ...
                rowClass = 'video'
                autoplay = fields.vimAutoplay
                loop = fields.vimLoop
                vim = '<div class="overlay" data-loop="' + loop + '" data-autoplay="' + autoplay + '" data-vimeoid="' + vimID + '">' +
    ...
    infiniteScroll: function() {
        ...
        $(window).scroll(function() {
            var offset = self.bodyh - self.winh - 230
            var st = $(window).scrollTop()
            if (st >= offset && self.isHome()) {
                $(window).scrollTop(0)
            }
    ...
    animProjectOpen: function() {
        ...
        tl
            .staggerTo('ul.corners > li:not(.spp, .home)', t, {
                y: 10,
                opacity: 0
            }, t / 2)
            ...
            .set('ul.projects, ul.corners > li:not(.spp, .home)', {
                display: 'none'
            })
            // setup project visibility
            .set([contentArr, imagesArr], {
                opacity: 0
            })
            .set('.single-project', {
                display: 'block'
            ...
            // Project Reveal
            .staggerTo([contentArr, imagesArr], t, {
                opacity: 1
            }, 1)
            .fromTo('ul.corners > li.spp', t, {
                y: 10,
                opacity: 0
            },{
                y: 0,
    ...
    animProjectClose: function() {
        ...
        tl
            ...
            .set('.single-project, ul.corners > li:not(.spp, .home)', {
                display: 'none'
            })
            ...
            .staggerFromTo('ul.corners > li:not(.spp, .home)', t, {
                y: 10,
                opacity: 0
            },{
              y: 0,
